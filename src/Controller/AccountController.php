...
/**
 * Controller de la page de gestion des comptes utilisateur. Cette dernière permet de visualiser les différents comptes, d'en créer ou d'en supprimer
 */
class AccountController extends AbstractController {
     ...
     * @return Response le twig correspondant à la page de gestion des comptes
     ...
     * @Route("/account/{id}", name="account_delete")
     */
